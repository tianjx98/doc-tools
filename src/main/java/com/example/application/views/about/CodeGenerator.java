    ...
    private static String getReqAssembleMethod(Map<String, String> paramMap) {
        String template =
                        "private {rqClassName} assemble{itfNameUpperCase}RequestDTO(ItfRegister itfRegister, List<{itfNameUpperCase}RqDTO> {itfName}RqDTOList) {\n"
                                        ...
                                        + "                        com.hand.hfins.common.infra.utils.DateUtils.dateToString(new Date(), Constants.DATE_FORMAT),\n"
                                        + "                        com.hand.hfins.common.infra.utils.DateUtils.dateToString(new Date(), Constants.TIME_FORMAT),\n"
                                        ...
                                        + "        dataBody.setSignTime(com.hand.hfins.common.infra.utils.DateUtils.dateToString(new Date(),\n"
